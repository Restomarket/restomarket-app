...
- **Task 2.7:** passing — SyncIngestService refactored to use ItemsRepository, WarehousesRepository, StockRepository
- **Task 6.1:** passing — `scripts/transform-convex-mappings.js` created; 102 mappings in `mappings-seed.json` (gitignored)
...
**Actual completion:** 31/31 tasks (100%)
...
| 2.7  | Refactor SyncIngest → Repositories | Gap Closure   | P1       | passing | Repositories injected, raw Drizzle removed |
