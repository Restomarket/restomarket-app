CREATE TABLE "customer_erp_profiles" (
...
ALTER TABLE "erp_code_mappings" ADD COLUMN "unit_id" uuid;--> statement-breakpoint
ALTER TABLE "erp_code_mappings" ADD COLUMN "vat_rate_id" uuid;--> statement-breakpoint
ALTER TABLE "erp_code_mappings" ADD COLUMN "family_id" uuid;--> statement-breakpoint
ALTER TABLE "erp_code_mappings" ADD COLUMN "subfamily_id" uuid;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "unit_id" uuid;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "vat_rate_id" uuid;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "family_id" uuid;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "subfamily_id" uuid;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "is_obsolete" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "erp_vat_id" varchar(100);--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "erp_updated_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "stock" ADD COLUMN "erp_updated_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "order_items" ADD COLUMN "erp_item_id" varchar(100);--> statement-breakpoint
ALTER TABLE "order_items" ADD COLUMN "erp_warehouse_id" varchar(100);--> statement-breakpoint
...
CREATE INDEX "customer_erp_profiles_vendor_id_idx" ON "customer_erp_profiles" USING btree ("vendor_id");--> statement-breakpoint
CREATE INDEX "customer_erp_profiles_organization_id_idx" ON "customer_erp_profiles" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX "customer_erp_profiles_user_id_idx" ON "customer_erp_profiles" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "customer_erp_profiles_erp_customer_id_idx" ON "customer_erp_profiles" USING btree ("erp_customer_id");--> statement-breakpoint
CREATE INDEX "customer_erp_profiles_is_active_idx" ON "customer_erp_profiles" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "units_vendor_id_idx" ON "units" USING btree ("vendor_id");--> statement-breakpoint
...
CREATE INDEX "vat_rates_vendor_id_idx" ON "vat_rates" USING btree ("vendor_id");--> statement-breakpoint
CREATE INDEX "vat_rates_code_idx" ON "vat_rates" USING btree ("code");--> statement-breakpoint
CREATE INDEX "vat_rates_is_active_idx" ON "vat_rates" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "families_vendor_id_idx" ON "families" USING btree ("vendor_id");--> statement-breakpoint
CREATE INDEX "families_code_idx" ON "families" USING btree ("code");--> statement-breakpoint
CREATE INDEX "families_is_active_idx" ON "families" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "subfamilies_vendor_id_idx" ON "subfamilies" USING btree ("vendor_id");--> statement-breakpoint
CREATE INDEX "subfamilies_family_id_idx" ON "subfamilies" USING btree ("family_id");--> statement-breakpoint
CREATE INDEX "subfamilies_code_idx" ON "subfamilies" USING btree ("code");--> statement-breakpoint
CREATE INDEX "subfamilies_is_active_idx" ON "subfamilies" USING btree ("is_active");--> statement-breakpoint
...
CREATE INDEX "erp_code_mappings_unit_id_idx" ON "erp_code_mappings" USING btree ("unit_id");--> statement-breakpoint
CREATE INDEX "erp_code_mappings_vat_rate_id_idx" ON "erp_code_mappings" USING btree ("vat_rate_id");--> statement-breakpoint
CREATE INDEX "erp_code_mappings_family_id_idx" ON "erp_code_mappings" USING btree ("family_id");--> statement-breakpoint
CREATE INDEX "erp_code_mappings_subfamily_id_idx" ON "erp_code_mappings" USING btree ("subfamily_id");--> statement-breakpoint
CREATE INDEX "items_unit_id_idx" ON "items" USING btree ("unit_id");--> statement-breakpoint
CREATE INDEX "items_vat_rate_id_idx" ON "items" USING btree ("vat_rate_id");--> statement-breakpoint
CREATE INDEX "items_family_id_idx" ON "items" USING btree ("family_id");--> statement-breakpoint
CREATE INDEX "items_subfamily_id_idx" ON "items" USING btree ("subfamily_id");--> statement-breakpoint
CREATE INDEX "items_is_obsolete_idx" ON "items" USING btree ("is_obsolete");--> statement-breakpoint
CREATE INDEX "items_erp_updated_at_idx" ON "items" USING btree ("erp_updated_at");--> statement-breakpoint
CREATE INDEX "stock_erp_updated_at_idx" ON "stock" USING btree ("erp_updated_at");